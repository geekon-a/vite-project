...
// ROZHRANÍ DEFINOVANÁ PŘÍMO ZDE, ABY SE NETLUKLA S IMPORTEY
interface Article {
  id: string;
  category: string;
  title: string;
...
function App() {
  return (
    <div className="bg-black min-h-screen text-white font-sans antialiased">
      ...
      {/* HERO SEKCE S YOUTUBE VIDEEM NA POZADÍ */}
      <header className="relative h-screen w-full flex items-center justify-center overflow-hidden bg-black">
        ...
        <div className="absolute inset-0 w-full h-full pointer-events-none overflow-hidden">
          <iframe 
            src="https://www.youtube.com/embed/nVgbMLDnFGs?autoplay=1&mute=1&loop=1&playlist=nVgbMLDnFGs&controls=0&showinfo=0&rel=0&modestbranding=1&iv_load_policy=3&playsinline=1"
            title="CORE XR X Video Background"
            className="absolute top-1/2 left-1/2 w-[100vw] h-[56.25vw] min-h-[100vh] min-w-[177.77vh] -translate-x-1/2 -translate-y-1/2 filter contrast-125 brightness-50"
      ...
      {/* SEKCE S PRODUKTY (S responzivním sliderem na mobilu) */}
      <main className="max-w-7xl mx-auto px-6 py-24 overflow-hidden">
        ...
        {/* Na mobilu flex s přetékáním do stran (swipe), od md (desktopu) klasický grid o 3 sloupcích */}
      ...
      {/* SEKCE AKCÍ (S responzivním gridem/sliderem uvnitř komponenty) */}
      <EventsSection 
